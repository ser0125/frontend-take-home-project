  ...
  return (
    <div className={styles.container}>
      <div className={styles.controls}>
        <div>
          <button onClick={handleDrawer} className={styles.buttonControl}>
            <Image src="/pencil.svg" alt="Pencil Logo" width={30} height={30} />
          </button>
          <button onClick={handleTextbox} className={styles.buttonControl}>
            <Image src="/letter.svg" alt="Letter Logo" width={30} height={30} />
          </button>
          <button onClick={handleEraser} className={styles.buttonControl}>
